        ...
        <>  <SubHeader />
            ...
            <div className='bg-white'>
                <div className='h-[150px] sm:h-[250px] bg-slate-700 flex justify-center items-center'>
                    <h5 className='tracking-wider text-xl sm:text-3xl text-white font-bold'>ABOUT US</h5>
                </div>
                <div className="container mx-auto w-[85%] sm:w-3/4 my-20">
                    <div className='flex flex-col sm:flex-row items-center gap-5'>
                        ...
                        <div className='flex-1 order-2 sm:order-1 mb-5 sm:mb-0'>
                            ...
                            <h2 className='text-4xl font-bold mb-5 text-black'>Lorem ipsum dolor sit amet consectetur</h2>
                            ...
                            <button className='px-6 py-3 bg-red-600 text-white mt-7 hover:bg-black transition-all'>Read More</button>
                        </div>
                    </div>
                </div>
            </div>
