            ...
            <div className="container mx-auto w-[85%] sm:w-3/4 py-20">
                <div className="w-full grid-cols-1 grid sm:grid-cols-3 gap-5">
                    ...
                    <div className="grid-cols-1 grid col-span-2 sm:grid-cols-3 justify-center items-center gap-8 sm:gap-5">
                        <div className='h-[400px] bg-cover bg-center rounded-xl hover:scale-105 transition duration-300 ease-in-out' style={{ backgroundImage: `url(${pImage1})` }}></div>
                        <div className='h-[400px] bg-cover bg-center rounded-xl hover:scale-105 transition duration-300 ease-in-out' style={{ backgroundImage: `url(${pImage2})` }}></div>
                        <div className='h-[400px] bg-cover bg-center rounded-xl hover:scale-105 transition duration-300 ease-in-out' style={{ backgroundImage: `url(${pImage3})` }}></div>
                    </div>
                </div>
