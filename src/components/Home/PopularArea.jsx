        ...
        <div className='bg-[skyblue] my-2'>
            <div className="container mx-auto w-[85%] sm:w-3/4 py-20">
                <div className="w-full grid-cols-1 grid sm:grid-cols-3 gap-5">
                    ...
                    <div className="grid-cols-1 grid col-span-2 sm:grid-cols-3 justify-center items-center gap-5">
                ...
                <div className="w-full grid-cols-1 grid sm:grid-cols-3 items-center gap-5 pt-10 sm:pt-20">
                    <div className='flex sm:justify-end justify-center lg:items-center gap-5'>
                        <h1 className='text-red-600 text-7xl font-semibold'>5K</h1>
                        <h2 className='text-back text-xl'>ACTIVE <br /> LISTING</h2>
                    </div>
                    <div className='flex sm:justify-end justify-center lg:items-center gap-5'>
                        <h1 className='text-red-600 text-7xl font-semibold'>8K</h1>
                        <h2 className='text-back text-xl'>ACTIVE <br /> LISTING</h2>
                    </div>
                    <div className='flex sm:justify-end justify-center lg:items-center gap-5'>
                        <h1 className='text-red-600 text-7xl font-semibold'>4K</h1>
                        <h2 className='text-back text-xl'>ACTIVE <br /> LISTING</h2>
                    </div>
                </div>
            </div>
