        ...
        <div className="mb-20">
            <div className="container mx-auto w-[85%] sm:w-3/4 py-20">
                ...
                <div className="w-full grid-cols-1 grid sm:grid-cols-3 justify-center items-center gap-8">
                    <div>
                        <div className='h-[200px] bg-cover bg-center p-4 rounded-xl hover:scale-105 transition duration-300 ease-in-out' style={{ backgroundImage: `url(${pImage1})` }}>
                    ...
                    <div>
                        <div className='h-[200px] bg-cover bg-center p-4 rounded-xl hover:scale-105 transition duration-300 ease-in-out' style={{ backgroundImage: `url(${pImage2})` }}>
                            <div className='w-full flex justify-between items-center'>
                                <div>
                                    <button className='bg-red-600 px-3 py-1 rounded-full text-white text-[13px] hover:bg-white hover:text-black transition duration-300 ease-in-out'>Featured</button>
                                </div>
                    ...
                    <div>
                        <div className='h-[200px] bg-cover bg-center p-4 rounded-xl hover:scale-105 transition duration-300 ease-in-out' style={{ backgroundImage: `url(${pImage3})` }}>
                            <div className='w-full flex justify-between items-center'>
                                <div>
                                    <button className='bg-red-600 px-3 py-1 rounded-full text-white text-[13px] hover:bg-white hover:text-black transition duration-300 ease-in-out'>Featured</button>
                                </div>
