            ...
            <div className="container mx-auto w-[95%] sm:w-3/4">
                <div className="relative flex items-center justify-between">
                    <div className="absolute inset-y-0 left-0 flex items-center sm:hidden" onClick={toggleOpen}>
                        ...
                        {
                            isOpen ?
                                <button type="button" className="relative inline-flex items-center justify-center p-2 border border-black text-black hover:bg-black hover:text-white transition focus:outline-none">
                    ...
                    <div className="flex py-4 flex-1 items-center justify-end sm:justify-between">
